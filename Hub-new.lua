...
MatsuneA1["6"]["Color"] = Color3.fromRGB(135, 206, 235);
...
_G.Color = Color3.fromRGB(135, 206, 235) 
_G.imageLogo = "rbxassetid://108644522770850"
_G.Logo = "rbxassetid://108644522770850"
_G.NameHub = "Made By Qminh" -- ชื่อ Hub
_G.Title = "Ân Nguyễn Hub-blox fruits" -- คำอธิบาย
-----------------------------------------------------------------
...
ImageButton.BorderColor3 = Color3.fromRGB(135, 206, 235)
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.new(0.120833337 - 0.10, 0, 0.0952890813 + 0.01, 0)
ImageButton.Size = UDim2.new(0, 40, 0, 40)
ImageButton.Draggable = true
ImageButton.Image = "rbxassetid://108644522770850"
...
Discord.BackgroundTransparency = 100 -- Làm cho nền trong suốt
...
Discord.MouseButton1Click:Connect(function()
    (setclipboard or toclipboard)("https://discord.gg/FmB5RCux")
    wait(.1)
	...
	function tabs:Tab(Name, icon)
		...
		function sections:Section(Name,side)
			    ...
			    while wait() do
			        pcall(function()
			            ...
			            game:GetService('TweenService'):Create(
 			               ...
 			               {BackgroundColor3 = Color3.fromRGB(135, 206, 235)} -- green color
			            ):Play() 
			            wait(0.5)            
			        end)
			    end
			...
			function functionitem:Button(Title, default, callback)
				...
				Button_2.BackgroundColor3 = Color3.fromRGB(135, 206, 235)
				...
				if default then
					TweenService:Create(
						...
						{
							BackgroundColor3 = state and _G.Color or Color3.fromRGB(135, 206, 235)
						}
					):Play()
					callback(default)
					Tgs = default
				...
				function b3Func:Update(state)
					TweenService:Create(
						...
						TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
						{
							BackgroundColor3 = state and Color3.fromRGB(135, 206, 235) or _G.Color
						}
					):Play()
					callback(state)
					Tgs = state
